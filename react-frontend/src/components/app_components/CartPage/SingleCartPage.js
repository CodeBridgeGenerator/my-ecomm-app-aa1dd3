  ...
  const copyPageLink = () => {
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            ...
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">CartItems</label><p className="m-0 ml-3" >{_entity?.cartItems}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">TotalPrice</label><p className="m-0 ml-3" ><InputNumber id="totalPrice" value={Number(_entity?.totalPrice)} mode="currency" currency="MYR" locale="en-US"   disabled={true} /></p></div>
