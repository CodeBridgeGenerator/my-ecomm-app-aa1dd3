...
const p_numberTemplate3 = (rowData, { rowIndex }) => <p >{rowData.stock}</p>
...
<Column field="stock" header="Stock" body={p_numberTemplate3} filter={selectedFilterFields.includes("stock")} hidden={selectedHideFields?.includes("stock")}  sortable style={{ minWidth: "8rem" }} />
